function [A,true_labels] = generate_easy_doughnut(N_per_cluster)
A = [];
i1 = randn(N_per_cluster,1)*0.3;
j1 = randn(N_per_cluster,1)*0.3;
for kk = 1:N_per_cluster
    r = rand; dummy1 = 5*sin(r*2*pi); dummy2 = 5*cos(r*2*pi);
    i2(kk) = dummy1-0.6*randn; j2(kk) = dummy2-0.6*randn;
end
