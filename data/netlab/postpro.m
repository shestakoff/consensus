...
del=load('del.dat');
m_sq=m_sq(1:times_count);m_mo=m_mo(1:times_count);m_j=m_j(1:times_count);m_a=m_a(1:times_count);m_h=m_h(1:times_count);m_c=m_c(1:times_count);m_s=m_s(1:times_count);m_d=m_d(1:times_count);
T_sq=T_sq(1:times_count);T_mo=T_mo(1:times_count);T_j=T_j(1:times_count);T_a=T_a(1:times_count);T_h=T_h(1:times_count);T_c=T_c(1:times_count);T_s=T_s(1:times_count);T_d=T_d(1:times_count);
aver_overlap_sq=aver_overlap_sq(1:times_count);aver_overlap_mo=aver_overlap_mo(1:times_count);aver_overlap_j=aver_overlap_j(1:times_count);aver_overlap_a=aver_overlap_a(1:times_count);aver_overlap_h=aver_overlap_h(1:times_count);aver_overlap_c=aver_overlap_c(1:times_count);aver_overlap_s=aver_overlap_s(1:times_count);aver_overlap_d=aver_overlap_d(1:times_count);
ari_sq=ari_sq(1:times_count);ari_mo=ari_mo(1:times_count);ari_j=ari_j(1:times_count);ari_a=ari_a(1:times_count);ari_h=ari_h(1:times_count);ari_c=ari_c(1:times_count);ari_s=ari_s(1:times_count);ari_d=ari_d(1:times_count);
adc_sq_eucli=adc_sq_eucli(1:times_count);adc_mo_eucli=adc_mo_eucli(1:times_count);adc_j_eucli=adc_j_eucli(1:times_count);adc_a_eucli=adc_a_eucli(1:times_count);adc_h_eucli=adc_h_eucli(1:times_count);adc_c_eucli=adc_c_eucli(1:times_count);adc_s_eucli=adc_s_eucli(1:times_count);adc_d_eucli=adc_d_eucli(1:times_count);
adc_sq_man=adc_sq_man(1:times_count);adc_mo_man=adc_mo_man(1:times_count);adc_j_man=adc_j_man(1:times_count);adc_a_man=adc_a_man(1:times_count);adc_h_man=adc_h_man(1:times_count);adc_c_man=adc_c_man(1:times_count);adc_s_man=adc_s_man(1:times_count);adc_d_man=adc_d_man(1:times_count);
clus_sq=clus_sq(1:times_count);clus_mo=clus_mo(1:times_count);clus_j=clus_j(1:times_count);clus_a=clus_a(1:times_count);clus_h=clus_h(1:times_count);clus_c=clus_c(1:times_count);clus_s=clus_s(1:times_count);clus_d=clus_d(1:times_count);
